...
ALTER TABLE fdn_projects ADD COLUMN resource_uuid VARCHAR(50) REFERENCES resources;
...
ALTER TABLE fdn_posts ADD COLUMN resource_uuid VARCHAR(50) REFERENCES resources;
...
ALTER TABLE user_posts ADD COLUMN resource_uuid VARCHAR(50) REFERENCES resources;
